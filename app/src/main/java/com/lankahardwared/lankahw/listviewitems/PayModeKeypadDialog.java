...
/**
 *Created by Dhanushika on 1/24/2018.
 * The custom designed keypad dialog is defined here.
 */
public class PayModeKeypadDialog extends Dialog {
...
//    }
    ...
    public PayModeKeypadDialog(Context context, boolean showPointFive, IOnOkClickListener okClickListener) {
        super(context, true, null);
//        this.context = context;
