...
import com.lankahardwared.lankahw.adapter.FreeItemsAdapter;
import com.lankahardwared.lankahw.adapter.InvDetAdapter;
import com.lankahardwared.lankahw.adapter.InvoiceDiscountAdapter;
import com.lankahardwared.lankahw.adapter.NewProduct_Adapter;
...
public class VanSalesOrderDetails extends Fragment {
        ...
        protected ArrayList<Product> doInBackground(Object... objects) {
            ...
            if (new ProductDS(getActivity()).tableHasRecords()) {
                productList = new ProductDS(getActivity()).getAllItems("");
                  ...
                  productList = new ItemsDS(getActivity()).getAllItems(new SalRepDS(getActivity()).getCurrentLocCode(), mainActivity.selectedDebtor.getFDEBTOR_PRILLCODE());
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                for (ItemFreeIssue itemFreeIssue : itemFreeIssues) {
                    ...
                    if (Integer.parseInt(itemFreeIssue.getAlloc()) > 0) {
                        ...
                        ordDet.setFINVDET_PRIL_CODE(mainActivity.selectedDebtor.getFDEBTOR_PRILLCODE());
        ...
        alertDialogBuilder.setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (Integer.parseInt(txtInputBox.getText().toString()) > 0) {
                    ...
                    mUpdateInvoice(invDet.getFINVDET_ID(), invDet.getFINVDET_ITEM_CODE(), txtInputBox.getText().toString(), invDet.getFINVDET_PRICE(), invDet.getFINVDET_SEQNO(), invDet.getFINVDET_QOH());
                } else
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                for (Product product : list) {
                    i++;
                    mUpdateInvoice("0", product.getFPRODUCT_ITEMCODE(), product.getFPRODUCT_QTY(), product.getFPRODUCT_PRICE(), i + "", product.getFPRODUCT_QOH());
                }
                return null;
            }
    ...
    public void mUpdateInvoice(String id, String itemCode, String Qty, String price, String seqno, String qoh) {
        ...
        invDet.setFINVDET_PRIL_CODE(mainActivity.selectedDebtor.getFDEBTOR_PRILLCODE());
