package com.lankahardwared.lankahw.view.expense;
...
public class ExpenseMain extends Fragment {
    ...
    ArrayList<FDayExpHed> loadexplist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btnType.equals("N")) {
                    activity.setTitle("UPLOAD DUE EXPENSES");
                    fab.setImageResource(R.drawable.tick);
                    btnType = "U";
                    dispalyExHistory("N");
                } else {
                    activity.setTitle("UPLOADED EXPENSES");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                loadexplist = new FDayExpHedDS(getActivity()).getAllExpHedDetails(newText);
   ...
   @Override
    public boolean onContextItemSelected(MenuItem item) {
        ...
        FDayExpHed dayHed = loadexplist.get(info.position);
    ...
    public void fatchData() {
        try {
            ...
            loadexplist = new FDayExpHedDS(getActivity()).getAllExpHedDetails("");
    ...
    public void dispalyExHistory(String params)
    {
        lv_expnes_load.clearTextFilter();
        loadexplist = new FDayExpHedDS(getActivity()).getAllUnsyncedExHed("", params);
        lv_expnes_load.setAdapter(new SalesExpenseHeader(getActivity(), loadexplist));
    }
    ...
    private void deleteDialog(final Context context, final String refno) {
        ...
        alertDialogBuilder.setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (new FDayExpHedDS(getActivity()).isEntrySynced(refno))
                    Toast.makeText(getActivity(), "Synced entry. Unable to delete.", Toast.LENGTH_LONG).show();
                else {
                    int count = new FDayExpHedDS(getActivity()).restDataExp(refno);
                    if (count > 0) {
                        new FDayExpDetDS(getActivity()).restDataExp(refno);
                        fatchData();
                    }
                }
            }
