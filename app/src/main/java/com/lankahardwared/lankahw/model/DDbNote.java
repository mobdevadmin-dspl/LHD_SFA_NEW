...
public class DDbNote {
    ...
    private String FDDBNOTE_TOTBALL;
    ...
    public String getFDDBNOTE_TOTBALL() {
        return FDDBNOTE_TOTBALL;
    }

    public void setFDDBNOTE_TOTBALL(String fDDBNOTE_TOTBALL) {
        FDDBNOTE_TOTBALL = fDDBNOTE_TOTBALL;
    }
