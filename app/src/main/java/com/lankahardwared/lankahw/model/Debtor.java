...
public class Debtor {
    ...
    private String FDEBTOR_IS_SYNCED;
    ...
    public String getFDEBTOR_IS_SYNCED() {
        return FDEBTOR_IS_SYNCED;
    }

    public void setFDEBTOR_IS_SYNCED(String FDEBTOR_IS_SYNCED) {
        this.FDEBTOR_IS_SYNCED = FDEBTOR_IS_SYNCED;
    }
