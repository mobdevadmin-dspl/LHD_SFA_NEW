...
public class TourHed {
    ...
    private String TOURHED_LOCNAME;
    ...
    public String getTOURHED_LOCNAME() {
        return TOURHED_LOCNAME;
    }

    public void setTOURHED_LOCNAME(String TOURHED_LOCNAME) {
        this.TOURHED_LOCNAME = TOURHED_LOCNAME;
    }
