...
public class FreeIssue {
    ...
    public ArrayList<ArrayList<TranSODet>> SortDiscount(ArrayList<TranSODet> newOrderList, String debCode) {
...
//                            }
                                ...
                                itemPrice = String.valueOf(Double.parseDouble(mTranSODet.getFTRANSODET_AMT())/(double)totalQTY);
                                ...
                                String oneItemTaxReversePrice[] = new TaxDetDS(context).calculateTaxForwardFromDebTax(debCode,mTranSODet.getFTRANSODET_ITEMCODE(), Double.parseDouble(itemPrice));
...
//                                    new TranSODetDS(context).updateDiscount(mTranSODet, discValue, "P");
//                                    Log.v("DISCOUNT", mTranSODet.getFTRANSODET_ITEMCODE() + " * " + (TotalValue - discValue));
                                    new TranSODetDS(context).updateDiscountSO(mTranSODet, totalReverseDiscValue, "P", debCode);
                                    Log.v("DISCOUNT", mTranSODet.getFTRANSODET_ITEMCODE() + " * " + (TotalValue - totalReverseDiscValue));
                                }
