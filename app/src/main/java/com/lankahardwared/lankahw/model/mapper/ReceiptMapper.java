...
public class ReceiptMapper {
	...
	private String FPRECHED_COMMON_REFNO;
	
	private String NextNumVal; // jjhjh
	private ArrayList<RecDet> RecDetList;
	private boolean IS_SYNCED;

	public String getFPRECHED_COMMON_REFNO() {
		return FPRECHED_COMMON_REFNO;
	}

	public void setFPRECHED_COMMON_REFNO(String FPRECHED_COMMON_REFNO) {
		this.FPRECHED_COMMON_REFNO = FPRECHED_COMMON_REFNO;
	}
	...
	public ArrayList<RecDet> getRecDetList() {
		return RecDetList;
	}
	public void setRecDetList(ArrayList<RecDet> recDetList) {
