...
public class FDayExpHed {
    private String EXPHED_REFNO;
    private String EXPHED_TXNDATE;
    private String EXPHED_DEALCODE;
    private String EXPHED_REPCODE;
    private String EXPHED_REPNAME;
    private String EXPHED_REMARK;
    private String EXPHED_COSTCODE;
    private String EXPHED_AREACODE;
    ...
    public void setEXPHED_ADDUSER(String eXPHED_ADDUSER) {
        EXPHED_ADDUSER = eXPHED_ADDUSER;
    }

    public String getEXPHED_DEALCODE() {
        return EXPHED_DEALCODE;
    }

    public void setEXPHED_DEALCODE(String eXPHED_DEALCODE) {
        EXPHED_DEALCODE = eXPHED_DEALCODE;
    }

    public String getEXPHED_COSTCODE() {
        return EXPHED_COSTCODE;
    }

    public void setEXPHED_COSTCODE(String eXPHED_COSTCODE) {
        EXPHED_COSTCODE = eXPHED_COSTCODE;
    }
    ...
    public String getEXPHED_REPNAME() {
        return EXPHED_REPNAME;
    }

    public void setEXPHED_REPNAME(String eXPHED_REPNAME) {
        EXPHED_REPNAME = eXPHED_REPNAME;
    }

    public String getEXPHED_AREACODE() {
        return EXPHED_AREACODE;
    }

    public void setEXPHED_AREACODE(String eXPHED_AREACODE) {
        EXPHED_AREACODE = eXPHED_AREACODE;
    }
