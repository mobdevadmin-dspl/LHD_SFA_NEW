...
public class FDayExpDet {

    private String EXPDET_ID;
    private String EXPDET_REFNO;
    private String EXPDET_TXNDATE;
    private String EXPDET_EXPCODE;
    private String EXPDET_SEQNO;
    private String EXPDET_AMOUNT;


    public String getEXPDET_ID() {
        return EXPDET_ID;
    }

    public void setEXPDET_ID(String eXPDET_ID) {
        EXPDET_ID = eXPDET_ID;
    }
    ...
    public String getEXPDET_SEQNO() {
        return EXPDET_SEQNO;
    }

    public void setEXPDET_SEQNO(String eXPDET_SEQNO) {
        EXPDET_SEQNO = eXPDET_SEQNO;
    }
