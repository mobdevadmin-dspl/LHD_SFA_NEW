...
public class TranSOHed implements Serializable{
    ...
    private String FTRANSOHED_TOTQTY;
    private String FTRANSOHED_TOTFREE;
   ...
   private ArrayList<TranSODet>soDetArrayList;

    public ArrayList<TranSODet> getSoDetArrayList() {
        return soDetArrayList;
    }

    public void setSoDetArrayList(ArrayList<TranSODet> soDetArrayList) {
    ...
    public void setfTRANSOHED_IS_SYNCED(String fTRANSOHED_IS_SYNCED) {
        this.fTRANSOHED_IS_SYNCED = fTRANSOHED_IS_SYNCED;
    }
    ...
    public String getFTRANSOHED_TOTQTY() {
        return FTRANSOHED_TOTQTY;
    }

    public void setFTRANSOHED_TOTQTY(String fTRANSOHED_TOTQTY) {
        FTRANSOHED_TOTQTY = fTRANSOHED_TOTQTY;
    }

    public String getFTRANSOHED_TOTFREE() {
        return FTRANSOHED_TOTFREE;
    }

    public void setFTRANSOHED_TOTFREE(String fTRANSOHED_TOTFREE) {
        FTRANSOHED_TOTFREE = fTRANSOHED_TOTFREE;
    }
