    ...
    public void importDB(String name) {
        try {
            ...
            if (sd.canWrite()) {
                ...
                String backupDBPath = "//" + APP_NAME + "//" + name;
...
//                File sd = Environment.getExternalStorageDirectory();
                ...
                if (sd.canWrite()) {
//                    String currentDBPath = "//data//" + PACKAGE_NAME + "//databases//" + DATABASE_NAME;
//                    String backupDBPath = "//" + APP_NAME + "//" + APP_NAME + " backup@" + dateFormat.format(date).toString() + ".db"; // From
    ...
    @SuppressLint("NewApi")
    public List<Import> getListOfFiles() {
