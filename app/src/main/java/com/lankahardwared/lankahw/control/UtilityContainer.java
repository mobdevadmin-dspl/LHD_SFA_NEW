...
import com.lankahardwared.lankahw.control.sqlite.SQLiteBackUp;
import com.lankahardwared.lankahw.control.sqlite.SQLiteRestore;
...
public class UtilityContainer {
    ...
    public static boolean mHttpManager(String sURL, String sJsonObject) throws Exception {
        ...
        if (is != null)
        {
            ...
            Log.d("UTILITY_CONTAINER", "BUFFERED_READER_LINE: " + result);
    ...
    public static void PreClearSharedPref(Context context) {
        ...
        editor.remove("preKeyIsFreeClicked");
        editor.remove("PrekeyRouteName");
        editor.commit();
    }
  /*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
    ...
    public static void ClearDepositSharedPref(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.remove("DepoAllocAmt");
        editor.remove("DepoRmnAmt");
        editor.commit();
    }
}
