...
public class InvHedDS {
    ...
    public ArrayList<VanSalesMapper> getAllUnsynced() {
        ...
        while (cursor.moveToNext()) {
            ...
            vanSalesMapper.setNextNumVal(new CompanyBranchDS(context).getCurrentNextNumVal(context.getResources().getString(R.string.VanNumVal)));
    ...
    public InvHed getDetailsforPrint(String Refno) {
        ...
        try {
            String selectQuery = "SELECT TxnDate,DebCode,Remarks,routecode,tourcode FROM " + DatabaseHelper.TABLE_FINVHED + " WHERE " + DatabaseHelper.FINVHED_REFNO + " = '" + Refno + "'";
