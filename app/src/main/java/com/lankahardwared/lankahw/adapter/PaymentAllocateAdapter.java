...
//        holder.remAmt.setText(paymentAllocate.getFPAYMENT_ALLOCATE_PAY_REM_AMT());
        holder.remAmt.setText(new PayModeDS(context).getRemAmtByPayRefNo(new PaymentAllocateDS(context).getPayRefNoByAllocRefNo(paymentAllocate.getFPAYMENT_ALLOCATE_REFNO())));
