...
import com.lankahardwared.lankahw.listviewitems.CustomKeypadDialog1;
import com.lankahardwared.lankahw.listviewitems.PayModeKeypadDialog;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        holder.amt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    final CustomKeypadDialog1 keypad = new CustomKeypadDialog1(context, false, new CustomKeypadDialog1.IOnOkClickListener() {
                        @Override
                        public void okClicked(double value) {
                            ...
                            if (enteredAmt>0)
                            {
                                new PayModeDS(context).updatePaidAmount(payMode.getFPAYMODE_REF_NO(), String.valueOf(enteredAmt));
                    ...
                    final CustomKeypadDialog keypad = new CustomKeypadDialog(context, false, new CustomKeypadDialog.IOnOkClickListener() {
                        ...
                        public void okClicked(double value) {
                            ...
                            else if (payMode.getFPAYMODE_PAID_ALLOAMT().equals("0.00"))
                            {
                                ...
                                new PayModeDS(context).updateRemainAmount(payMode.getFPAYMODE_PAID_ID(), String.valueOf(remAmt));
                                new PayModeDS(context).updateAllocateAmt(payMode.getFPAYMODE_PAID_ID(), String.valueOf(enteredAmt));
                ...
                else if (!payMode.getFPAYMODE_PAID_ALLOAMT().equals("0.00"))
                {
                    final PayModeKeypadDialog keypad = new PayModeKeypadDialog(context, false, new PayModeKeypadDialog.IOnOkClickListener() {
                        ...
                        public void okClicked(double value) {
                            ...
                            {
                                if (Double.parseDouble(new PayModeDS(context).getPayModeRemAmtByRefNo(payMode.getFPAYMODE_REF_NO()))>0)
                                {
                                    Double lastRemAmt = Double.parseDouble(new PayModeDS(context).getPayModeRemAmtByRefNo(payMode.getFPAYMODE_REF_NO()));
                                    ...
                                    new PayModeDS(context).updateRemainAmount(payMode.getFPAYMODE_PAID_ID(), String.valueOf(finalRemAmt));
                                    new PayModeDS(context).updateAllocateAmt(payMode.getFPAYMODE_PAID_ID(), String.valueOf(enteredAmt));
                                    payMode.setFPAYMODE_PAID_ALLOAMT(String.valueOf(enteredAmt));
...
//        });
    ...
    public void updatePaymodeDialogBox(final Holder holder, String paymodeRefNo)
    {
        ...
        allPayModeList = new PayModeDS(context).getPayModeByRefNo(paymodeRefNo);
